defmodule PhoenixContainedWeb.CoreComponents do
  @moduledoc """
  ...
  def square(assigns) do
    ~H"""
    <div class="flex items-center justify-center w-12 h-12 border rounded bg-blue-500">
      <%= @title %>
    </div>
    """
  end
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhoenixContainedWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhoenixContainedWeb.Gettext, "errors", msg, opts)
    end
  end
